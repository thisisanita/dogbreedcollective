  ...
  return (0, import_jsx_runtime78.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime78.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime78.jsx)(Typography_default, {
        color: "text.secondary",
        children
      }) : (0, import_jsx_runtime79.jsxs)(React68.Fragment, {
...
var NativeSelect = React76.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime90.jsx)(React76.Fragment, {
...
var SliderTrack = styled_default("span", {
  ...
  const color = (
    ...
    theme.palette.mode === "light" ? (0, import_colorManipulator15.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator15.darken)(theme.palette[ownerState.color].main, 0.5)
  );
  return _extends({
    display: "block",
    position: "absolute",
...
var SliderThumb = styled_default("span", {
  ...
  [`&:hover, &.${sliderClasses_default.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator15.alpha)(theme.palette[ownerState.color].main, 0.16)}`,
    "@media (hover: none)": {
      boxShadow: "none"
    }
  },
  [`&.${sliderClasses_default.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator15.alpha)(theme.palette[ownerState.color].main, 0.16)}`
  },
  [`&.${sliderClasses_default.disabled}`]: {
    "&:hover": {
      boxShadow: "none"
...
var Tooltip = React101.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React101.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime120.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime121.jsxs)(React101.Fragment, {
    children: [React101.cloneElement(children, childrenProps), (0, import_jsx_runtime120.jsx)(PopperComponent, _extends({
...
var Step = React107.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime128.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime127.jsxs)(React107.Fragment, {
...
var StepButton = React112.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React112.cloneElement(children, childProps) : (0, import_jsx_runtime135.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React117.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime141.jsxs)(React117.Fragment, {
...
var Tab = React119.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime144.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime144.jsxs)(React119.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime144.jsxs)(React119.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var TablePaginationActions = React131.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return (0, import_jsx_runtime155.jsxs)("div", _extends({
    ...
    children: [showFirstButton && (0, import_jsx_runtime154.jsx)(FirstButtonSlot, _extends({
      onClick: handleFirstPageButtonClick,
      disabled: disabled || page === 0,
      "aria-label": getItemAriaLabel("first", page),
      title: getItemAriaLabel("first", page)
    }, firstButtonSlotProps, {
      children: isRtl ? (0, import_jsx_runtime154.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon)) : (0, import_jsx_runtime154.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon))
    })), (0, import_jsx_runtime154.jsx)(PreviousButtonSlot, _extends({
      ...
      children: isRtl ? (0, import_jsx_runtime154.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon)) : (0, import_jsx_runtime154.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon))
    })), (0, import_jsx_runtime154.jsx)(NextButtonSlot, _extends({
      ...
      children: isRtl ? (0, import_jsx_runtime154.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon)) : (0, import_jsx_runtime154.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon))
    })), showLastButton && (0, import_jsx_runtime154.jsx)(LastButtonSlot, _extends({
      onClick: handleLastPageButtonClick,
      disabled: disabled || page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": getItemAriaLabel("last", page),
      title: getItemAriaLabel("last", page)
    }, lastButtonSlotProps, {
      children: isRtl ? (0, import_jsx_runtime154.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon)) : (0, import_jsx_runtime154.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon))
    }))]
  }));
});
...
var TextField = React139.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime166.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime167.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime166.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime166.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime166.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
